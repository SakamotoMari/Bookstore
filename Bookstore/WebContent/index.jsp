...
<!-- start slider -->
  <link href="<%=basePath%>css/slider.css" rel="stylesheet" type="text/css" media="all" />
        <script type="text/javascript" src="<%=basePath%>js/jquery.eislideshow.js"></script>
  ...
  <div class="header">
    ...
    <div class="web_search">
      <form action="servlet/SearchAction" method="post">
        <input type="text" name="searchName" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '';}" />
